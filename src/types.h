...
typedef struct _pref_t {
	...
	/* trackpad (BlackBerry Classic) */
	int trackpad_enabled, trackpad_sensitivity;
	char *trackpad_click_keys;

	/* keystrokes sent by the hardware back button */
	char *back_button_keys;

	/* extra lines of scrollback history */
